...
//	[piece removeFromSuperview];
	...
	[UIView beginAnimations:nil context:(__bridge void *)piece];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	ChipmunkNearestPointQueryInfo *info = [space nearestPointQueryNearest:point maxDistance:0.0 layers:CP_ALL_LAYERS group:[BoardView class]];
	[self removePiece:info.shape.data];
}
